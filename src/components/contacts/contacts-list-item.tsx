...
export default function ContactsListItem({
  ...
  return (
    <div className="flex items-center gap-x-2 rounded p-1 px-2 transition hover:cursor-pointer hover:bg-white/15">
      ...
      <RemoveFriendModal
        ...
        contactId={contactId}
      >
        <UserMinusIcon className="h-9 w-9 rounded-full bg-black p-2 transition hover:text-red-500 md:bg-none md:group-hover:block md:group-hover:bg-black" />
      </RemoveFriendModal>
    </div>
  );
}
